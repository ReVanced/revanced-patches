...
val hideInboxSubtabsPatch = bytecodePatch(
    ...
    val createInboxSubTabsFingerprintResult by createInboxSubTabsFingerprint

    execute {
        createInboxSubTabsFingerprintResult.mutableMethod.replaceInstruction(2, "const/4 v0, 0x0")
    }
}
