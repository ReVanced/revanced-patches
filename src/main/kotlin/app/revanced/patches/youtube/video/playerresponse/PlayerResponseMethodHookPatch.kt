...
val playerResponseMethodHookPatch = bytecodePatch {
    ...
    val playerParameterBuilderResult by playerParameterBuilderFingerprint

    execute {
        playerResponseMethod = playerParameterBuilderResult.mutableMethod
    }
    ...
    finalize {
        ...
        playerResponseMethod.addInstructions(
            ...
            """
                ...
                move-object/from16 v$REGISTER_PROTO_BUFFER, p$REGISTER_PROTO_BUFFER
