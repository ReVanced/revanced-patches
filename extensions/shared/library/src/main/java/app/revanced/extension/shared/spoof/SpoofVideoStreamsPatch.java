...
public class SpoofVideoStreamsPatch {
    ...
    /**
     * Injection point. Used by YT Music.
     */
    public static void setClientTypeToIosMusic() {
        Logger.printDebug(() -> "Setting stream spoofing to: " + ClientType.IOS_MUSIC);
        BaseSettings.SPOOF_VIDEO_STREAMS_CLIENT_TYPE.save(ClientType.IOS_MUSIC);
    }
