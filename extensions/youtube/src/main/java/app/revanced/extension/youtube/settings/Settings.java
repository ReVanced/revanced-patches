...
public class Settings extends BaseSettings {
    ...
    public static final BooleanSetting REMOVE_PLAYER_CONTROL_BUTTONS_BACKGROUND = new BooleanSetting("revanced_remove_player_control_buttons_background", FALSE, true);
