...
public class Settings extends BaseSettings {
    ...
    public static final BooleanSetting PLAYBACK_SPEED_DIALOG_BUTTON = new BooleanSetting("revanced_playback_speed_dialog_button", FALSE, false,"revanced_playback_speed_dialog_button_message");
