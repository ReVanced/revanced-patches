...
public class VideoQualityDialogButton {
    ...
    private static int getDrawableIdentifier(String resourceName) {
        final int resourceId = Utils.getResourceIdentifier(ResourceType.DRAWABLE, resourceName);
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.checkIcon = convertView.findViewById(
                        Utils.getResourceIdentifier(ResourceType.ID, "revanced_check_icon")
                );
                viewHolder.placeholder = convertView.findViewById(
                        Utils.getResourceIdentifier(ResourceType.ID, "revanced_check_icon_placeholder")
                );
                viewHolder.textView = convertView.findViewById(
                        Utils.getResourceIdentifier(ResourceType.ID, "revanced_item_text")
                );
