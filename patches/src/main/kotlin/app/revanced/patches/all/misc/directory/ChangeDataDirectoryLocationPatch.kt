...
import app.revanced.patches.all.misc.directory.documentsprovider.internalDataDocumentsProviderExtensionPatch

@Suppress("unused")
@Deprecated(
    "Superseded by internalDataDocumentsProviderExtensionPatch",
    ReplaceWith("internalDataDocumentsProviderExtensionPatch")
)
