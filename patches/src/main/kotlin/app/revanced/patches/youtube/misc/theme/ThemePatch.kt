package app.revanced.patches.youtube.misc.theme
...
import app.revanced.patches.youtube.seekbar.seekbarcolor.seekbarColorPatch
...
val themePatch = bytecodePatch(
    ...
    execute {
        addResources("youtube", "misc.theme.themePatch")
