package app.revanced.patches.youtube.shorts.shortsplayer
...
import app.revanced.patches.youtube.player.fullscreen.openVideosFullscreenHookPatch
...
val openShortsInRegularPlayerPatch = bytecodePatch(
    ...
    execute {
        addResources("youtube", "shorts.shortsplayer.shortsPlayerTypePatch")
