...
val lithoFilterPatch = bytecodePatch(
    ...
    execute {
        ...
        val builderMethodDescriptor = emptyComponentFingerprint.matchOrThrow.classDef.methods.first { method ->
        ...
        if (is_19_25_or_greater) {
            lithoComponentNameUpbFeatureFlagFingerprint.matchOrThrow.method.apply {
        ...
        lithoConverterBufferUpbFeatureFlagFingerprint.matchOrThrow.method.apply {
