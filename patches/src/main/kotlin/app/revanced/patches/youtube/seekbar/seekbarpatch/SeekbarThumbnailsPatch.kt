...
import app.revanced.patches.youtube.seekbar.seekbarcolor.fullscreenSeekbarThumbnailsFingerprint
...
val seekbarThumbnailsPatch = bytecodePatch(
    ...
    execute {
        ...
        addResources("youtube", "seekbar.seekbarpatch.seekbarThumbnailsPatch")
