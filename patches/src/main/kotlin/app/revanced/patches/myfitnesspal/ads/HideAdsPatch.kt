...
val hideAdsPatch = bytecodePatch(
    ...
    execute {
        ...
        isPremiumUseCaseImplFingerprint.matchOrThrow.method.replaceInstructions(
            0,
            """
        ...
        mainActivityNavigateToNativePremiumUpsellFingerprint.matchOrThrow.method.replaceInstructions(
            0,
            "return-void",
        )
    }
