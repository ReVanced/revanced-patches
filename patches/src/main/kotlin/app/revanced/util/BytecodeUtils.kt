...
// TODO: Convert to extension property.
@Deprecated("Use the extension property instead.", ReplaceWith("matchOrThrow"))
...
fun Fingerprint.applyMatch(context: BytecodePatchContext, parentMatch: Match) =
    also { match(context, parentMatch.classDef) }.matchOrThrow()
